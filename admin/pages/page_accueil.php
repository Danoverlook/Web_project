...
if (!isset($_GET['idgenre'])) {
    echo '<div id="title"><h4>Liste des films par ordre alphabétique</h4><a href="./pages/print_liste_film.php" target="_blank">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspvisionner le PDF</a><img src="./images/pdf.jpg" id="img_pdf" alt="Pdf"/></div>';
    for ($i = 0; $i < $nbrfilm; $i++) {
        ?>
    ...
    echo '<h4>Liste des films du genre ' . $_GET['nomgenre'] . '<br/><br/><br/></h4>';
